...
class RAGRequest(BaseModel):
    ...
    query_optimizer: str = Field("hyde", description="检索前优化策略: hyde / rewrite / multi_query / none")
    llm_model: str = Field("qwen-plus", description="LLM模型: qwen-plus / qwen-max / qwen-turbo")
...
class RAGResponse(BaseModel):
    ...
    latency: float = Field(..., description="总耗时(秒)")
